        ...
        <ul class="am-list admin-sidebar-list">
            ...
            <li class="admin-parent">
                ...
                <ul class="am-list am-collapse admin-sidebar-sub am-in" id="collapse-nav">
                    <li><a href="/config.do"><span class="am-icon-group"></span> 个人设置</a></li>
                    <li><a href="/system-setting.do"><span class="am-icon-cog"></span> 系统设置</a></li>
                </ul>
            </li>
            ...
            <li><a href="/help.do"><span class="am-icon-globe"></span> 帮助</a></li>
            <li><a href="/about.do"><span class="am-icon-leaf"></span> 关于</a></li>
