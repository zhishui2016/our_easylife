	...
	<head>
		...
		$(function(){
            ...
            $(".readAll").click(function(){
                ...
                document.getElementById("detailimages").src=images;
                //打开模式框
                $("#myModal").modal("show");
            });
		});
		...
		<div class="container">
			<div class="row">
                ...
                <div class="col-sm-9" style="font-size: 18px">
					...
					<#list pageResult.result as popular>
						<ul class="list-unstyled">
							<li>
								<#--新闻标题-->
                                <div>
                                    <a id="title" style="font-size: 22px;color: #0e0e0e" href="${(popular.sourceUrl)!''}"><b>${(popular.title)!''}</b></a>
                                    <a href="javascript:void(-1);"  class="readAll" data-json='${(popular.jsonString)!''}'><b>点击阅读全文</b></a>
                                </div>
                                <#--新闻发布时间-->
                                    <div id="publishTime">${(popular.publishTime)!''}</div>
                                </br>
								<#--新闻图片-->
								...
								<#--先隐藏内容点击更多才显示全部内容-->
								<div id="content" style="display: none">${(popular.content)!''}</div>
							</li>
						</ul>
						<#--模态框-->
                                    ...
                                    <div class="modal-body">
                                        <form class="form-horizontal" id="editform" method="post">
                                            <fieldset style="align-content: center">
                                                ...
                                                <div id="tbodyContent">
                                                    <img src="" alt="" name="images" id="detailimages" style="width: 80%">
