 ...
 */
public class PopularReptiles implements PageProcessor{
    private static final List<Popular> list = new ArrayList<>();
    private static int count = 0;
    private static final String indexUrl = "https://www.toutiao.com/api/pc/feed/?category=news_tech&utm_source=toutiao&widen=1&max_behot_time=";
   // private static final String indexUrl = "https://www.toutiao.com/api/pc/feed/?category=news_popular&utm_source=toutiao&widen=1&max_behot_time=1500122920&max_behot_time_tmp=1500122920&tadrequire=true&as=A125A9A6BA337C2&cp=596A73470CE2BE1";
    ...
    public void process(Page page) {
        ...
        if (myUrl.contains(indexUrl)) {
            ...
            popular.setContent(content);
            popular.setPublishTime(publish_time);
            popular.setSource(source);
            popular.setTitle(title);
            popular.setSourceUrl(detailUrl);
            popular.setImages(images);
            //存储数据
            list.add(popular);
        }
    }
    ...
    public static List<Popular> getData() {
        return list;
    }
