...
public class BitStatesUtils {
	...
	public final static Long OP_HAS_ADD_GOODGLYPHICON = 1L << 8;// 用户是否点过好赞了
	public final static Long OP_HAS_ADD_COMMONGLYPHICON = 1L << 9;// 用户是否点过中赞了
	public final static Long OP_HAS_ADD_BADGLYPHICON = 1L << 10;// 用户是否点过差赞了
